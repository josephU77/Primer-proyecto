========================================================================
    APLICACIÓN DE CONSOLA: TestDataCYP03 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación TestDataCYP03.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación TestDataCYP03.


TestDataCYP03.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado TestDataCYP03.pch y un archivo de tipos 
